...
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(193, 'Hide Reviews Ratings', 'SERVICE_REVIEW_HIDE_REVIEWS_RATING', 'Yes', 'Hide Reviews Rating Stars.', 6, 0, now(), now(), '', 'lc_cfg_set_boolean_value(array(\'Yes\', \'No\'))');
