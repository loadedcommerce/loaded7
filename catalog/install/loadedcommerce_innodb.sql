...
INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(176, 'Uploadcare Public Key', 'EDITOR_UPLOADCARE_PUBLIC_KEY', 'demopublickey', 'Add your Uploadcare public key. <a href="https://uploadcare.com/accounts/settings/" target="_blank">Get your Uploadcare Public Key</a>', 20, 6, NULL, now(), NULL, NULL);
