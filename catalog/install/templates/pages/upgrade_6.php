  ...
  if (http.readyState == 4) {
    if (http.status == 200) {
      ...
      if (result[0] == '1') {
        ...
        setTimeout("document.getElementById('upgradeForm2').submit();", 2000);
      } else if (result[0] == '0') {
...
function prepareWork() {
  ...
  var bValid = $("#upgradeForm2").validate({
    rules: {
...
<form name="upgrade" id="upgradeForm2" action="upgrade.php?step=7" method="post" class="block wizard-enabled" onsubmit="prepareWork(); return false;">
  ...
  <fieldset class="wizard-fieldset fields-list current active">
    ...
    <div class="field-block margin-bottom" style="padding-left:20px;">
      <h4><?php echo $lC_Language->get('upgrade_step6_page_title'); ?></h4>
      <p><?php echo $lC_Language->get('upgrade_step6_page_desc'); ?></p>
    </div>
