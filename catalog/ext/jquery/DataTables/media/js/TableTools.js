...
TableTools.buttonBase = {
	...
	"sTag": "default",
	"sLinerTag": "default",
	"sButtonClass": "button with-tooltip icon-redo blue",
	"sButtonText": "",
	"sTitle": "",
	"sToolTip": "",
...
TableTools.BUTTONS = {
	"csv": $.extend( {}, TableTools.buttonBase, {
		"sAction": "flash_save",
    "sToolTip": "Save CSV File",
		"sButtonClass": "icon-new-tab red",
		"sButtonText": "", //CSV
		"sFieldBoundary": '"',
		"sFieldSeperator": ",",
	...
	"xls": $.extend( {}, TableTools.buttonBase, {
		...
		"sCharSet": "utf16le",
		"bBomInc": true,
    "sToolTip": "Save Excel File",
		"sButtonClass": "icon-read orange",
		"sButtonText": "", //Excel
		"fnClick": function( nButton, oConfig, flash ) {
			this.fnSetText( flash, this.fnGetTableData(oConfig) );
		}
	...
	"pdf": $.extend( {}, TableTools.buttonBase, {
		...
		"sFileName": "*.pdf",
    "sToolTip": "Save PDF",
		"sButtonClass": "icon-page-list green",
		"sButtonText": "",  // PDF
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		...
		"bShowAll": true,
		"sToolTip": "Print",
		"sButtonClass": "icon-printer red with-tooltip",
		"sButtonText": "", // Print
...
TableTools.classes_themeroller = {
	...
	"buttons": {
		"normal": "button ui-button ui-state-default"
	},
	"collection": {
