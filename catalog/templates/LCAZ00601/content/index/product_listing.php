...
<div class="row listing-container">
  <div class="listing-title"><h1 class="no-margin-top"><?php echo $lC_Template->getPageTitle(); ?></h1></div>
  ...
  $(".product-listing-module-items").each(function(){
   ...
   var textAddToWishlist = '<?php echo $lC_Language->get('add_to_wishlist'); ?>';
    ...
    output = '<div class="' + thisContentClass+ ' with-padding">'+
             ...
             '      <div class="info col-xs-4 col-sm-4 col-lg-4">'+ nameContent +'</div> '+         
             '      <div class="wishlist  col-xs-4 col-sm-4 col-lg-4"><a href="javascript:void(0);" >' + textAddToWishlist + '</a></div> '+    
             '       <div class="cart  col-xs-4 col-sm-4 col-lg-4">'+ buttonContent +'</div> ' +
             '      </div> '+
             '  </div>' +
             '</div>';   
