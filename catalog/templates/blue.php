<?php
/**  
*  $Id: blue.php v1.0 2013-01-01 datazen $
*
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <!-- Boilerplate CSS -->
    <link rel="stylesheet" href="templates/blue/css/normalize.min.css">
    <!-- Template CSS -->
    <link rel="stylesheet" href="templates/blue/css/styles.css">
    ...
    <link rel="stylesheet" href="templates/blue/css/loadmask.css?v=1">     
    ...
    <script src="templates/blue/javascript/modernizr-2.6.2-respond-1.1.0.min.js"></script> 
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div class="section_container">
        <section>
          ...
          <?php
            // the blue css is set for both columns visible until now
    ...
    <!-- Template functions -->
    <script src="templates/blue/javascript/jquery.flexslider.js" ></script>
    <script src="templates/blue/javascript/jquery.jcarousel.js"></script>
    <script src="templates/blue/javascript/jquery.jtweetsanywhere-1.3.1.min.js" ></script>
    <script src="templates/blue/javascript/jquery.magnify-1.0.2.js"></script>
    <script src="templates/blue/javascript/form_elements.js" ></script>
    <script src="templates/blue/javascript/placeholder.js" ></script>
