  ...
  <div class="embed-form short-code-column one-half column-last no-margin-bottom">
    ...
    <ul id="address_details">
      <?php
        ...
        if (ACCOUNT_SUBURB > -1) {
          echo '<li>' . lc_draw_label('', null, 'suburb', (ACCOUNT_SUBURB > 0)) . ' ' . lc_draw_input_field('suburb', (isset($Qentry) ? $Qentry->value('entry_suburb') : null), 'placeholder="' . $lC_Language->get('field_customer_suburb') . '" onfocus="this.placeholder = \'\'" onblur="this.placeholder = \'' . $lC_Language->get('field_customer_suburb') . '\'" class="txt ' . ((ACCOUNT_SUBURB > 0) ? 'required' : null) . '" holder="text" style="width:99%;"') . '</li>';
        }
        echo '<li>' . lc_draw_label('', 'city', null, '', true) . ' ' . lc_draw_input_field('city', (isset($Qentry) ? $Qentry->value('entry_city') : null), 'placeholder="' . $lC_Language->get('field_customer_city') . '" onfocus="this.placeholder = \'\'" onblur="this.placeholder = \'' . $lC_Language->get('field_customer_city') . '\'" holder="text" class="txt" style="width:99%;"') . '</li>';
      ...
      <?php
        if (ACCOUNT_POST_CODE > -1) {
          echo '<li>' . lc_draw_label('', null, 'postcode', (ACCOUNT_POST_CODE > 0)) . ' ' . lc_draw_input_field('postcode', (isset($Qentry) ? $Qentry->value('entry_postcode') : null), 'placeholder="' . $lC_Language->get('field_customer_post_code') . '" onfocus="this.placeholder = \'\'" onblur="this.placeholder = \'' . $lC_Language->get('field_customer_post_code') . '\'" class="txt ' . ((ACCOUNT_POST_CODE > 0) ? 'required' : null) . '" holder="text" style="width:99%;"') . '</li>';
        }
      ?>
    </ul>    
  </div>
