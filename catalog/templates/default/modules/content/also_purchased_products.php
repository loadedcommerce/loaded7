...
$(document).ready(function() {
  ...
  $(".content-also-purchased-products-container").each(function(){
    ...
    output = '<li>'+ imageContent + 
             ...
             '  </div>' +
             '  <div class="price_info" style="margin-top:10px;"> <a href="javascript(void);" onclick="alert(\'' + textFeatureNotAvailable + '\'); return false;">' + textAddToWishlist + '</a>' + buttonContent +
             '  </div>' +
             '</li>';
