            ...
            <div id="checkout_shipping_col1" style="width:35%; float:left;">
              ...
              <div id="order-comments-block">
                ...
                <div id="confirmation-order-comment-inner">
                  <?php echo lc_draw_textarea_field('comments', (isset($_SESSION['comments']) ? $_SESSION['comments'] : null), null, null, 'placeholder="' . $lC_Language->get('text_add_comment_to_order') . '" onfocus="this.placeholder=\'\'" onblur="sendOrderCommentsToSession(this.value);this.placeholder=\'' . $lC_Language->get('text_add_comment_to_order') . '\';" style="height:47px; width:98%"'); ?>
                </div>
              </div>
            </div>
