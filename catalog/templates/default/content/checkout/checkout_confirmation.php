                ...
                <div class="col2-set" id="order-comment-grand-total">
                  <div id="confirmation-order-comment">
                    ...
                    <div id="confirmation-order-comment-inner">
                      <?php echo lc_draw_textarea_field('comments', (isset($_SESSION['comments']) ? $_SESSION['comments'] : null), null, null, 'placeholder="' . $lC_Language->get('text_add_comment_to_order') . '" onfocus="this.placeholder = \'\'" onblur="this.placeholder = \'' . $lC_Language->get('text_add_comment_to_order') . '\'" style="height:47px; width:100%"'); ?>
                    </div>
                  </div>
