<?php
  /*
  $Id: checkout_shipping_address.php v1.0 2011-11-04 datazen $
...
<!--SHIPPING ADDRESS SECTION STARTS-->
  <div id="checkoutShippingAddress" class="full_page">
    <h1><?php echo $lC_Template->getPageTitle(); ?></h1>        
    <div class="short-code-column">
      <form name="checkout_address" id="checkout_address" action="<?php echo lc_href_link(FILENAME_CHECKOUT, 'shipping_address=process', 'SSL'); ?>" method="post" onsubmit="return check_form_optional(checkout_address);">
      <?php
      ...
      <div id="checkoutShippingAddressDetails">
        <h4><?php echo $lC_Language->get('new_shipping_address_title'); ?></h4>
        ...
        ?>
      <div id="checkoutShippingAddressActions" class="action_buttonbar">
