<?php
/*
  $Id: tell_a_friend.php v1.0 2011-11-04 datazen $
...
?>
<!--PRODUCT TELL A FRIEND SECTION STARTS-->
  <div class="full_page">
    <!--PRODUCT TELL A FRIEND CONTENT STARTS-->
    <div class="content">
    ...
    <div style="clear:both;">&nbsp;</div>
    <!--PRODUCT TELL A FRIEND CONTENT ENDS-->
    <!--PRODUCT TELL A FRIEND ACTIONS STARTS-->
    ...
    <div style="clear:both;"></div>
    <!--PRODUCT TELL A FRIEND ACTIONS ENDS-->
  </div>
<!--PRODUCT TELL A FRIEND SECTION ENDS-->