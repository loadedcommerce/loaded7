  ...
  <div class="single-bg">
    <div class="short-code-column one-half no-margin-bottom lg-input-height">   
      ...
      <ul id="personal_details">
        <li><?php echo lc_draw_label('', 'firstname', null, false) . ' ' . lc_draw_input_field('firstname', null, 'placeholder="' . $lC_Language->get('field_customer_first_name') . '" class="txt" style="width:99%;"'); ?></li>
        <li><?php echo lc_draw_label('', 'lastname', null, false) . ' ' . lc_draw_input_field('lastname', null, 'placeholder="' . $lC_Language->get('field_customer_last_name') . '" class="txt" style="width:99%;"'); ?></li>
        <?php
        if (ACCOUNT_DATE_OF_BIRTH == '1') {
          ...
          echo '<li>' . lc_draw_label('', 'dob_days', null, false) . ' ' . lc_draw_input_field('dob', null, 'placeholder="' . $lC_Language->get('field_customer_date_of_birth') . '" class="txt required date" style="width:86%;"') . '</li>'; 
        }
        if (ACCOUNT_GENDER > -1) {
    ...
    <div class="short-code-column one-half column-last no-margin-bottom lg-input-height">
      <h3>Login Details</h3>
      <ul id="login_details">    
        <li><?php echo lc_draw_label('', 'email_address', '', false) . ' ' . lc_draw_input_field('email_address', ($_POST['email']) ? $_POST['email'] : '', 'placeholder="' . $lC_Language->get('field_customer_email_address') . '" class="txt" style="width:100%;"'); ?></li>
        <li><?php echo lc_draw_label('', 'password', null, false) . ' ' . lc_draw_password_field('password', 'class="txt" style="width:100%;" placeholder="' . $lC_Language->get('field_customer_password') . '"'); ?></li>
        <li><?php echo lc_draw_label('', 'confirmation', null, false) . ' ' . lc_draw_password_field('confirmation', 'placeholder="' .  $lC_Language->get('field_customer_password_confirmation') . '" class="txt" style="width:100%;"'); ?></li>
        <?php
