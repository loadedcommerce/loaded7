<?php
/*
  $Id: account_history.php v1.0 2011-11-04 datazen $
...
*/
?>
<!--ACCOUNT HISTORY SECTION STARTS-->
  <div class="full_page">
    <!--ACCOUNT HISTORY CONTENT STARTS-->
    <div class="content">
      <div class="short-code-column">
        <h1><?php echo $lC_Template->getPageTitle(); ?></h1> 
        <div class="borderPadMe">
          <!--ACCOUNT HISTORY LISTING STARTS-->
          ...
          <!--ACCOUNT HISTORY LISTING ENDS--> 
        </div>
        <div style="clear:both;">&nbsp;</div>
        <!--ACCOUNT HISTORY ACTIONS STARTS-->
        ...
        <div style="clear:both;"></div>
        <!--ACCOUNT HISTORY ACTIONS ENDS-->  
      </div>
    </div>
    <!--ACCOUNT HISTORY CONTENT ENDS-->
  </div>
<!--ACCOUNT HISTORY SECTION ENDS-->