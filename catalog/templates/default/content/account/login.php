  ...
  <div class="single-bg" style="width:38%;">
    <div class="short-code-column margin-bottom">  
      ...
      <ul id="login_list">
        ...
        <li><?php echo lc_draw_label('', 'password', null, false) . ' ' . lc_draw_password_field('password', 'onfocus="this.placeholder = \'\'" onblur="this.placeholder = \'' . $lC_Language->get('field_customer_password') . '\'" holder="' . $lC_Language->get('field_customer_password') . '" class="txt" style="width:99%;" placeholder="' . $lC_Language->get('field_customer_password') . '"'); ?></li>
