...
<div id="accountLogin" class="full_page">
  ...
  <div class="single-bg" style="width:38%;">
    <div class="short-code-column margin-bottom">  
      ...
      <ul id="login_list">
        <li><?php echo lc_draw_label('', 'email_address', '', false) . ' ' . lc_draw_input_field('email_address', ($_POST['email']) ? $_POST['email'] : '', 'placeholder="' . $lC_Language->get('field_customer_email_address') . '" onfocus="this.placeholder = \'\'" onblur="this.placeholder = \'' . $lC_Language->get('field_customer_email_address') . '\'" holder="text" class="txt" style="width:99%;"'); ?></li>
        <li><?php echo lc_draw_label('', 'password', null, false) . ' ' . lc_draw_password_field('password', 'onfocus="this.placeholder = \'\'" onblur="this.placeholder = \'' . $lC_Language->get('field_customer_password') . '\'" holder="text" class="txt" style="width:99%;" placeholder="' . $lC_Language->get('field_customer_password') . '"'); ?></li>
