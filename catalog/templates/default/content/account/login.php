...
<div id="accountLogin" class="full_page">
  ...
  <div class="single-bg" style="width:38%;">
    <div class="short-code-column margin-bottom">  
      ...
      <ul id="login_list">
        <li><?php echo lc_draw_label('', 'email_address', '', false) . ' ' . lc_draw_input_field('email_address', (($_POST['email']) ? $_POST['email'] : '' || ($_SESSION['email_passthru']) ? $_SESSION['email_passthru'] : ''), 'placeholder="' . $lC_Language->get('field_customer_email_address') . '" class="txt" style="height:26px; padding-left:4px; width:99%;"'); ?></li>
