  ...
  */
  public static function getZonesDropdownHtml($countries_id, $zone = null) {
    ...
    if ($Qzones->numberOfRows() > 0) {
      ...
      $result['zonesHtml'] = lc_draw_label('', null, 'state') . ' ' . lc_draw_input_field('state', (($zone != 'undefined') ? $zone : null), 'placeholder="' . $lC_Language->get('field_customer_state') . '" onfocus="this.placeholder = \'\'" onblur="this.placeholder = \'' . $lC_Language->get('field_customer_state') . '\'" class="required" style="width:98%;"');
      $result['single'] = '1';
    }
