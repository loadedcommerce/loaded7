...
$(document).ready(function() {
  ...
  $(".product-listing-module-items").each(function(){
    ...
    var priceContent = $(this).find('div.product-listing-module-price').html(); <?php //echo $lC_Product->getPriceFormated(true); ?>
    ...
    output = '<div class="' + thisContentClass+ ' with-padding">'+
             ...
             '        </div>' +
              '         <div>'+          
              '         <span class="margin-right"><?php echo lc_image(DIR_WS_TEMPLATE_IMAGES . 'stars_' . $lC_Product->getData('reviews_average_rating') . '.png', sprintf($lC_Language->get('rating_of_5_stars'), $lC_Product->getData('reviews_average_rating'))); ?></span>'+
             '          </div>' +
