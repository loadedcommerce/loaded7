...
/**
  ...
  @version    $Id: LCAZ00595.php v1.0.1 2014-02-20 datazen $
*/
require($lC_Vqmod->modCheck('templates/LCAZ00595/classes/output.php'));
$code = (isset($_SESSION['template']['code']) && $_SESSION['template']['code'] != NULL) ? $_SESSION['template']['code'] : 'LCAZ00595';
...
<html lang="<?php echo substr(strtolower($lC_Language->getCode()), 0, 2); ?>">
  <head>
    ...
    <meta name="description" content="Template LCAZ00595 for Loaded Commerce Shopping Cart">
