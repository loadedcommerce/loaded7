    ...
    <div class="row">
      <div class="col-sm-12 col-lg-12 large-margin-bottom">
        ...
        <div class="button-set">
          ...
          <p class="help-block margin-left"><a href="javsscript(void);" onclick="javascript:window.open('<?php echo lc_href_link(FILENAME_SEARCH, 'help'); ?>', 'searchHelp', 'location=0, status=0, toolbar=0, menubar=0, scrollbars=1, width=600, height=445'); return false"><?php echo $lC_Language->get('search_help_tips'); ?></a></p>
        </div>      
      </div>
    </div>
