...
<div class="row-fluid">
  <div class="span12">
    <h1><?php echo $lC_Language->get('reviews_heading'); ?></h1>
    <div class="row">
            ...
            <div class="row-fluid margin-top">
              ...
              <div class="span6 no-margin-left">
                <a href="<?php echo lc_href_link(basename($_SERVER['SCRIPT_FILENAME']), $lC_Product->getKeyword() . '&' . lc_get_all_get_params(array('action', 'new')) . '&action=cart_add'); ?>">
                  <button class="btn btn-success btn-block large" type="button">Buy Now</button>
                </a>
              </div>
            </div>
          </div>
      ...
      <div class="span8">
        ...
        <div class="content-product-reviews-container">  
          <h3><?php echo $lC_Template->getPageTitle(); ?></h3>  
          <?php
