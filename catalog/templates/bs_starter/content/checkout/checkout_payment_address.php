...
/**  
  ...
  @version    $Id: checkout_payment_address.php v1.0 2013-08-08 datazen $
*/ 
?>
          ...
          <div class="row large-margin-top">
            ...
            <div class="col-sm-8 col-lg-8">
                  ...
                  if (isset($_GET['payment_address']) && ($_GET['payment_address'] != 'process')) {
                    ...
                    if (lC_AddressBook::numberOfEntries() > 1) {
                      ...
                      <div class="clear-both clearfix">
                        ...
                        <div class="alert alert-warning"><?php echo $lC_Language->get('select_another_billing_destination'); ?></div>
                        <?php
                        $radio_buttons = 0;
                        ...
                        while ($Qaddresses->next()) {
                          ...
                          <td class="text-right"><?php echo lc_draw_radio_field('address', $Qaddresses->valueInt('address_book_id'), $lC_ShoppingCart->getBillingAddress('id'), null, 'id="address_' . $lC_ShoppingCart->getShippingAddress('id') . '"'); ?></td>
                          </tr>
                          </table>
                          <?php
                          $radio_buttons++;
              ...
              <div class="btn-set clearfix">
                ...
                <button class="btn btn-lg btn-primary" type="button" id="payment-address-form" style="display:none;"><?php echo $lC_Language->get('show_address_form'); ?></button>
              </div> 
            </div>
          </div> <!-- /row -->        
        </div>
