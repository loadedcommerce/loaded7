                    ...
                    if (lC_AddressBook::numberOfEntries() > 1) {
                      ...
                      <div class="clear-both clearfix">
                        ...
                        while ($Qaddresses->next()) {
                          ...
                          <td class="text-right"><?php echo lc_draw_radio_field('address', $Qaddresses->valueInt('address_book_id'), $lC_ShoppingCart->getBillingAddress('id'), 'id="address_' . $lC_ShoppingCart->getShippingAddress('id') . '"', ''); ?></td>
                          </tr>
                          </table>
                          <?php
                          $radio_buttons++;
