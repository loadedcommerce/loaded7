...
/**
  ...
  @version    $Id: LCAZ00602.php v1.0.1 2014-02-20 datazen $
*/
require($lC_Vqmod->modCheck('templates/LCAZ00602/classes/output.php'));
$code = (isset($_SESSION['template']['code']) && $_SESSION['template']['code'] != NULL) ? $_SESSION['template']['code'] : 'LCAZ00602';
