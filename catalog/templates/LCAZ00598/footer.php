  ...
  <div class="container" style="width:100%;">
    <div class="container_controller">
      <div class="row">
        ...
        <!-- QR Code -->
        <div id="qr-code-container" class="pull-right margin-right margin-bottom" style="padding-right:10px; padding-top:44px;">        
          <a id="qrcode-tooltip">
        ...
        <div class="margin-left small-padding-left margin-right small-padding-right clear-both large-margin-top-neg"><p><?php echo $lC_Template->getBranding('footer_text');?></p></div>
      </div>    
    </div>  
  </div> 
</div>
