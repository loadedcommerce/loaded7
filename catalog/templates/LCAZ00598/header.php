...
<div class="page-header">
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4 col-lg-3 pull-right cart-container">
      	<div class="row carttop">
      		<div class="col-sm-3">
      		<a href="<?php echo lc_href_link(FILENAME_CHECKOUT, 'cart', 'NONSSL'); ?>"><img alt="View Cart" src="<?php echo DIR_WS_TEMPLATE_IMAGES; ?>basket.png" /></a>
      		</div>
      		<div class="col-sm-9">
            <p >
              <a href="<?php echo lc_href_link(FILENAME_CHECKOUT, 'cart', 'NONSSL'); ?>">Shopping Cart</a> <br /> You have (<?php echo $lC_ShoppingCart->numberOfItems(); ?>) items
            </p>   
        	</div>   
      	</div>
      </div>     
