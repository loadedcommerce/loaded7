          ...
          <div class="panel-body no-padding-bottom">
            <div class="row">
              ...
              <div class="col-sm-8 col-lg-8">
                ...
                echo ((sizeof($selection) > 1) ? '<div class="alert alert-warning">' . $lC_Language->get('choose_payment_method') . '</div>' : ((sizeof($selection) == 1) ? '22<div class="alert alert-warning">' . $lC_Language->get('only_one_payment_method_available') . '</div>' : '<div class="alert alert-warning">' . $lC_Language->get('no_payment_method_available') . '</div>' . "\n")); 
                $radio_buttons = 0;
