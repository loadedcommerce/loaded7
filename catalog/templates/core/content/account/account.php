...
<div class="row">
  ...
  <div class="col-sm-12 col-lg-12">
    ...
    <div class="well clearfix large-margin-right">
      ...
      <div>
        <div><?php echo lc_link_object(lc_href_link(FILENAME_ACCOUNT, 'edit', 'AUTO'), $lC_Language->get('my_account_information')); ?></div>
        <div><?php echo lc_link_object(lc_href_link(FILENAME_ACCOUNT, 'address_book', 'AUTO'), $lC_Language->get('my_account_address_book')); ?></div>
        <div><?php echo lc_link_object(lc_href_link(FILENAME_ACCOUNT, 'password', 'AUTO'), $lC_Language->get('my_account_password')); ?></div>
      </div>
    </div>
    ...
    <div class="well clearfix large-margin-right">
      ...
      <div>
        <div><?php echo lc_link_object(lc_href_link(FILENAME_ACCOUNT, 'orders', 'AUTO'), $lC_Language->get('my_orders_view')); ?></div>
      </div>
    </div>
    ...
    <div class="well clearfix large-margin-right">
      ...
      <div>
        <div><?php echo lc_link_object(lc_href_link(FILENAME_ACCOUNT, 'newsletters', 'AUTO'), $lC_Language->get('my_notifications_newsletters')); ?></div>
        <div><?php echo lc_link_object(lc_href_link(FILENAME_ACCOUNT, 'notifications', 'AUTO'), $lC_Language->get('my_notifications_products')); ?></div>
      </div>
    </div>  
  </div>
</div>
