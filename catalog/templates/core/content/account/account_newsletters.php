...
<div class="row">
  <div class="col-sm-12 col-lg-12">
    ...
    <form role="form" class="form-inline" name="account_newsletter" id="account_newsletter" action="<?php echo lc_href_link(FILENAME_ACCOUNT, 'newsletters=save', 'AUTO'); ?>" method="post">
      <div class="well">
        <div class="checkbox">
