...
<div class="row">
  <div class="col-sm-12 col-lg-12">
    ...
    <div class="btn-set small-margin-top clearfix">
      <form action="<?php echo lc_href_link(FILENAME_ACCOUNT, 'address_book=' . preg_replace('/[^0-9]/', '', $_GET['address_book']) . '&delete=confirm', 'AUTO'); ?>" method="post"><button class="pull-right btn btn-lg btn-primary" onclick="$(this).closest('form').submit();" type="submit"><?php echo $lC_Language->get('button_delete'); ?></button></form>
      <form action="<?php echo lc_href_link(FILENAME_ACCOUNT, 'address_book', 'AUTO'); ?>" method="post"><button class="pull-left btn btn-lg btn-default" onclick="$(this).closest('form').submit();" type="submit"><?php echo $lC_Language->get('button_back'); ?></button></form>
    </div>     
  </div>
</div>  
