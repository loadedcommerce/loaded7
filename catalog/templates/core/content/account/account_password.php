...
<div class="row">
  <div class="col-sm-12 col-lg-12">
    ...
    ?>
    <div class="well">
      <form role="form" name="account_password" id="account_password" action="<?php echo lc_href_link(FILENAME_ACCOUNT, 'password=save', 'AUTO'); ?>" method="post" onsubmit="return check_form(account_password);">
