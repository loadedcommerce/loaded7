...
class Paypal_Payments_Standard extends lC_Addon {
  /*
  * Class constructor
  */
  public function Paypal_Payments_Standard() {    
    ...
    */     
    $this->_thumbnail = lc_image(DIR_WS_CATALOG . 'addons/' . $this->_code . '/images/paypal_std.png');
   /**
  ...
  */
  public function install() {
    ...
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Canceled Status', 'ADDONS_PAYMENT_" . strtoupper($this->_code) . "_ORDER_CANCELED_STATUS_ID', '10', 'Set the status of <b>Canceled</b> orders made with this payment module', '6', '9', 'lc_cfg_use_get_order_status_title', 'lc_cfg_set_order_statuses_pull_down_menu(class=\"select\",', now())");
