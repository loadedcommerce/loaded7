...
class United_Parcel_Service extends lC_Addon {
  /*
  * Class constructor
  */
  ...
  */
  public function install() {
    ...
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transaction Server', 'ADDONS_SHIPPING_" . strtoupper($this->_code) . "_PICKUP', 'CC', 'How do you give packages to UPS? CC = Customer Counter, RDP = Daily Pickup, OTP = One Time Pickup, LC = Letter Center, OCA = On Call Air.', '6', '0', 'lc_cfg_set_boolean_value(array(\'CC\', \'RDP\', \'OTP\', \'LC\', \'OCA\'))', now())");
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transaction Server', 'ADDONS_SHIPPING_" . strtoupper($this->_code) . "_PACKAGE', 'CP', 'CP = Your Packaging, ULE = UPS Letter, UT = UPS Tube, UBE = UPS Express Box.', '6', '0', 'lc_cfg_set_boolean_value(array(\'CP\', \'ULE\', \'UT\', \'UBE\'))', now())");
