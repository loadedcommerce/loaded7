...
*/
class Global_Iris_Payments extends lC_Addon { // your addon must extend lC_Addon
  /*
  * Class constructor
  */
  public function Global_Iris_Payments() {    
    ...
    */     
    $this->_thumbnail = lc_image(DIR_WS_CATALOG . 'addons/' . $this->_code . '/images/iris.png', $this->_title);
   /**
