...
*/
class Fedex_Web_Services extends lC_Addon { // your addon must extend lC_Addon
  /*
  * Class constructor
  */
  public function Fedex_Web_Services() {    
    ...
    */     
    $this->_thumbnail = lc_image(DIR_WS_CATALOG . 'addons/' . $this->_code . '/images/fedex.png', $this->_title);
   /**
