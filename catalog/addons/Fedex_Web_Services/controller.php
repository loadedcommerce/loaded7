...
class Fedex_Web_Services extends lC_Addon {
  ...
  */
  public function install() {
    ...
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Ground Handling Fee', 'ADDONS_SHIPPING_" . strtoupper($this->_code) . "_HANDLING_FEE', '', 'Add a domestic handling fee or leave blank (example: 15 or 15%).', '6', '0', now())");
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Home Delivery Fee', 'ADDONS_SHIPPING_" . strtoupper($this->_code) . "_HOME_DELIVERY_HANDLING_FEE', '', 'Add a home delivery handling fee or leave blank (example: 15 or 15%).', '6', '0', now())");
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Express Handling Fee', 'ADDONS_SHIPPING_" . strtoupper($this->_code) . "_EXPRESS_HANDLING_FEE', '', 'Add a domestic handling fee or leave blank (example: 15 or 15%).', '6', '0', now())");
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Int\'l Ground Handling Fee', 'ADDONS_SHIPPING_" . strtoupper($this->_code) . "_INT_HANDLING_FEE', '', 'Add an international handling fee or leave blank (example: 15 or 15%).', '6', '0', now())");
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Int\'l Express Handling Fee', 'ADDONS_SHIPPING_" . strtoupper($this->_code) . "_INT_EXPRESS_HANDLING_FEE', '', 'Add an international handling fee or leave blank (example: 15 or 15%).', '6', '0', now())");
