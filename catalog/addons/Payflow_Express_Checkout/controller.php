...
*/
class Payflow_Express_Checkout extends lC_Addon { // your addon must extend lC_Addon
  /*
  * Class constructor
  */
  public function Payflow_Express_Checkout() {    
    global $lC_Language;    
   /**
    ...
    */    
    $this->_code = 'Payflow_Express_Checkout';        
   /**
    * The addon title used in the addons store listing
    */     
    $this->_title = $lC_Language->get('addon_payment_payflow_EC_title');
   /**
    * The addon description used in the addons store listing
    */     
    $this->_description = $lC_Language->get('addon_payment_payflow_EC_description');
   /**
    * The addon blurb used in the addons store listing
    */     
    $this->_blurb = $lC_Language->get('addon_payment_payflow_EC_blurb');    
   /**
    * The developers name
    */    
