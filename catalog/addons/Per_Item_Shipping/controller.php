...
*/
class Per_Item_Shipping extends lC_Addon { // your addon must extend lC_Addon
  /*
  * Class constructor
  */
  public function Per_Item_Shipping() {    
    ...
    */     
    $this->_thumbnail = lc_image(DIR_WS_CATALOG . 'addons/' . $this->_code . '/images/item.png', $this->_title);
   /**
