...
*/
class Flat_Rate_Shipping extends lC_Addon { // your addon must extend lC_Addon
  /*
  * Class constructor
  */
  public function Flat_Rate_Shipping() {    
    ...
    */     
    $this->_thumbnail = lc_image(DIR_WS_CATALOG . 'addons/' . $this->_code . '/images/flat.png', $this->_title);
   /**
