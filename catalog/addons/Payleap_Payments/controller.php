...
/*
  ...
  @license    http://payleap.com/license.html
*/
class Payleap_Payments extends lC_Addon { // your addon must extend lC_Addon
  /*
  * Class constructor
  */
  public function Payleap_Payments() {    
    global $lC_Language;    
   /**
    ...
    */    
    $this->_code = 'Payleap_Payments';       
   /**
    * The addon title used in the addons store listing
    */     
    $this->_title = $lC_Language->get('addon_payment_payleappayments_title');
   /**
    * The addon description used in the addons store listing
    */     
    $this->_description = $lC_Language->get('addon_payment_payleappayments_description');
   /**
    * The developers name
    */    
    $this->_author = 'Acculynk';
   /**
    * The developers web address
    */    
    $this->_authorWWW = 'http://www.payleap.com';    
   /**
    * The addon version
    */     
    $this->_version = '1.0.0';
    ...
    */     
    $this->_thumbnail = lc_image(DIR_WS_CATALOG . 'addons/' . $this->_code . '/images/payleap.png', $this->_title);
   /**
