...
*/       
class Pro_Pack_602 extends lC_Addon { // your addon must extend lC_Addon
  /*
  * Class constructor
  */
  public function Pro_Pack_602() {    
    global $lC_Language;    
   /**
    ...
    */    
    $this->_code = 'Pro_Pack_602';       
   /**
    * The addon title used in the addons store listing
    */     
    $this->_title = $lC_Language->get('addon_pro_pack_602_title');
   /**
    * The addon description used in the addons store listing
    */     
    $this->_description = $lC_Language->get('addon_pro_pack_602_description');
   /**
    * The developers name
    */    
    ...
    */     
    $this->_thumbnail = '<span onclick="showInfo(\'Pro_Pack_602\',\'LCAZ00602\', \'' . $this->_title . '\');">' . lc_image(DIR_WS_CATALOG . 'addons/' . $this->_code . '/images/LCAZ00602.png', null, 160, 120) . '</span>';
   /**
