...
class USAePay_Payments extends lC_Addon {
  /*
  * Class constructor
  */
  ...
  */
  public function install() {
    ...
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Transaction Source Key', 'ADDONS_PAYMENT_" . strtoupper($this->_code) . "_TRANSACTION_SOURCE_KEY', '', 'The Transaction source key obtained from the Merchant Interface.', '6', '0', now())");
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Transaction Source Pin(optional)', 'ADDONS_PAYMENT_" . strtoupper($this->_code) . "_TRANSACTION_SOURCE_PIN', '', 'Pin for Source Key. This field is required only if the merchant has set a Pin in the merchant console. .', '6', '0', now())");
