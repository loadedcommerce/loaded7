...
*/
class PayPal_Payments_Pro extends lC_Addon { // your addon must extend lC_Addon
  /*
  * Class constructor
  */
  public function PayPal_Payments_Pro() {    
    global $lC_Language;    
   /**
    ...
    */    
    $this->_code = 'PayPal_Payments_Pro';        
   /**
    * The addon title used in the addons store listing
    */     
    $this->_title = $lC_Language->get('addon_paypal_payments_pro_title');
   /**
    * The addon description used in the addons store listing
    */     
    $this->_description = $lC_Language->get('addon_paypal_payments_pro_description');      
   /**
    * The developers name
    */    
    ...
    */     
    $this->_thumbnail = lc_image(DIR_WS_CATALOG . 'addons/' . $this->_code . '/images/paypal_pro.png', $this->_title);
   /**
