...
require_once(DIR_FS_CATALOG . 'addons/Loaded_7_B2B/admin/applications/categories/classes/categories.php');
...
class lC_Categories_Admin_rpc { 
  ...
  */
  public static function batchEditAccess() {
    $result = array();
    $updated = lC_Categories_b2b_Admin::batchEditAccess($_GET);
    if ($updated) {
