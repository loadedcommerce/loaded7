...
*/
class CRE_Secure_Payments extends lC_Addon { // your addon must extend lC_Addon
  /*
  * Class constructor
  */
  public function CRE_Secure_Payments() {    
    global $lC_Language;    
   /**
    ...
    */     
    $this->_title = $lC_Language->get('addon_payment_cresecure_title');
   /**
    * The addon description used in the addons store listing
    */     
    $this->_description = $lC_Language->get('addon_payment_cresecure_description');
   /**
    * The developers name
    */    
  ...
  */
  public function install() {
    ...
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Account ID', 'ADDONS_PAYMENT_" . strtoupper($this->_code) . "_LOGIN', '', 'The Account ID used for the CRE Secure payment service.', '6', '0', now())");
    $lC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('API Token', 'ADDONS_PAYMENT_" . strtoupper($this->_code) . "_API_TOKEN', '', 'The API Token used for the CRE Secure payment service.', '6', '0', now())");
