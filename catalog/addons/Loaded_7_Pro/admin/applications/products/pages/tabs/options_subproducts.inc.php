...
<div id="multiSKUOptionsContainer" class="margin-top">  
	<span class="float-right" style="margin:-46px 0px 4px 0;"><a class="button icon-plus-round green-gradient glossy compact" href="javascript:void(0)" onclick="addComboOption();"><?php echo $lC_Language->get('button_setup'); ?></a></span>
