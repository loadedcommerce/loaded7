...
*/
  ...
  class lC_Checkout_Shipping extends lC_Template {
    ...
    function lC_Checkout_Shipping() {
      global $lC_Database, $lC_ShoppingCart, $lC_Customer, $lC_Services, $lC_Language, $lC_NavigationHistory, $lC_Breadcrumb, $lC_Shipping;
    ...
    /* Private methods */
    function _process() {
      global $lC_ShoppingCart, $lC_Shipping;
