...
class lC_Index_Manufacturers extends lC_Template {
  ...
  function lC_Index_Manufacturers() {
    global $lC_Services, $lC_Language, $lC_Breadcrumb, $lC_Manufacturer, $lC_Vqmod;
  ...
  /* Private methods */
  function _process() {
    global $lC_Manufacturer, $lC_Products, $lC_Vqmod;

    include($lC_Vqmod->modCheck('includes/classes/products.php'));
