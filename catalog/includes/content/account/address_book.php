<?php
/*
  $Id: address_book.php v1.0 2011-11-04 datazen $
...
*/
  ...
  class lC_Account_Address_book extends lC_Template {
    ...
    function lC_Account_Address_book() {
      global $lC_Language, $lC_Services, $lC_Breadcrumb, $lC_Customer, $lC_MessageStack;
    ...
    function _process($id = '') {
      global $lC_MessageStack, $lC_Database, $lC_Language, $lC_Customer, $entry_state_has_zones;
