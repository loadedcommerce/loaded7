<?php
/*
  $Id: mysql.php v1.0 2011-11-04 datazen $
...
*/
  ...
  class lC_Database_mysql extends lC_Database {
    ...
    function lC_Database_mysql($server, $username, $password) {
      $this->server = $server;
    ...
    function freeResult($resource) {
      if (@mysql_free_result($resource)) {
        ...
        $this->setError('Resource \'lC_Database->' . $resource . '\' could not be freed.');
