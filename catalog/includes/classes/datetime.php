...
/**
  ...
  @version    $Id: datetime.php v1.0 2013-08-08 datazen $
*/
class lC_DateTime {
  ...
  public function getShort($date = null, $with_time = false) {
    global $lC_Language;
  ...
  public function getLong($date = '', $with_time = false) {
    global $lC_Language;
  ...
  public function validate($date_to_check, $format_string, &$date_array) {
    $separator_idx = -1;
