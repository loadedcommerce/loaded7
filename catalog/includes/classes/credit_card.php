<?php
/*
  $Id: credit_card.php v1.0 2013-01-01 datazen $
...
*/
  ...
  class lC_CreditCard {
    ...
    /* Class constructor */
    function lC_CreditCard($number = '', $exp_month = '', $exp_year = '') {
      global $lC_Database;
      ...
      $Qcc = $lC_Database->query('select id, credit_card_name as title, pattern from :table_credit_cards where credit_card_status = "1" order by sort_order, credit_card_name');
