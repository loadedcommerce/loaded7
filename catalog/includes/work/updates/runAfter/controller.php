...
class lC_Updates_Admin_run_after extends lC_Updates_Admin {
  ...
  public static function updateDB() {
    ...
    $lC_Database->simpleQuery("ALTER IGNORE TABLE `" . $pf . "adminiatrators` ADD `language_id` INT( 11 ) NOT NULL DEFAULT '1'  AFTER `verify_key`");
    parent::log("Database Update: ALTER IGNORE TABLE `" . $pf . "adminiatrators` ADD `language_id` INT( 11 ) NOT NULL DEFAULT '1' AFTER `verify_key`");
