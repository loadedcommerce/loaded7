...
class lC_Updates_Admin_run_after extends lC_Updates_Admin {
  ...
  public static function updateDB() {
    ...
    $lC_Database->simpleQuery("UPDATE `" . $pf . "branding` ADD `homepage_text` TEXT NOT NULL AFTER `language_id`;");
    parent::log("Database Update: UPDATE `" . $pf . "branding` ADD `homepage_text` TEXT NOT NULL AFTER `language_id`;");
