...
class lC_Updates_Admin_run_after extends lC_Updates_Admin {
  ...
  public static function updateDB() {
    ...
    $lC_Database->simpleQuery("ALTER IGNORE TABLE `" . $pf . "adminiatrators` ADD `verify_key` VARCHAR( 64 ) DEFAULT NULL AFTER `access_group_id`");
    parent::log("Database Update: ALTER IGNORE TABLE `" . $pf . "adminiatrators` ADD `verify_key` VARCHAR( 64 ) DEFAULT NULL AFTER `access_group_id`");
    $lC_Database->simpleQuery("ALTER IGNORE TABLE `" . $pf . "adminiatrators` ADD `language_id` VARCHAR( 64 ) DEFAULT NULL AFTER `verify_key`");
    parent::log("Database Update: ALTER IGNORE TABLE `" . $pf . "adminiatrators` ADD `language_id` VARCHAR( 64 ) DEFAULT NULL AFTER `verify_key`");
    ...
    $lC_Database->simpleQuery("INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(166, 'Enable/Disable Editor(Global)', 'ENABLE_EDITOR', '1', 'Enable or Disable Editor Globally', 20, 1, NULL, '2013-07-03 15:58:32', 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))')");
    parent::log("Database Update: INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(166, 'Enable/Disable Editor(Global)', 'ENABLE_EDITOR', '1', 'Enable or Disable Editor Globally', 20, 1, NULL, '2013-07-03 15:58:32', 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))')");
    $lC_Database->simpleQuery("INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(167, 'Use Default Template Stylesheet', 'USE_DEFAULT_TEMPLATE_STYLESHEET', '-1', 'Use Default Template Stylesheet', 20, 2, NULL, '2013-07-03 15:58:32', 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))')");
    parent::log("Database Update: INSERT INTO lc_configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(167, 'Use Default Template Stylesheet', 'USE_DEFAULT_TEMPLATE_STYLESHEET', '-1', 'Use Default Template Stylesheet', 20, 2, NULL, '2013-07-03 15:58:32', 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))')");
