...
class lC_Updates_Admin_run_after extends lC_Updates_Admin {
  ...
  public static function updateDB() {
    ...
    $lC_Database->simpleQuery("INSERT IGNORE INTO `" . $pf . "configuration_group` (configuration_group_id, configuration_group_title, configuration_group_description, sort_order, visible) VALUES (23, 'Product Info Page', 'Settings specific to the product information page.', 22, 1);");
    parent::log("Database Update: INSERT IGNORE INTO `" . $pf . "configuration_group` (configuration_group_id, configuration_group_title, configuration_group_description, sort_order, visible) VALUES (23, 'Product Info Page', 'Settings specific to the product information page.', 22, 1);");
