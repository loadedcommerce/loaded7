...
class lC_Updates_Admin_run_after extends lC_Updates_Admin {
  ...
  public static function updateDB() {
    ...
    if (!defined('EMAIL_SMTP_HOST_SERVER')) {
      $lC_Database->simpleQuery("INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(193, 'SMTP Server Host Address', 'EMAIL_SMTP_HOST_SERVER', '', 'The fully qualified host name or IP address of the SMTP server.', 12, 6, now(), now(), NULL, NULL);");
    ...
    if (!defined('EMAIL_SMTP_PORT_SERVER')) {
      $lC_Database->simpleQuery("INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(194, 'SMTP Server Port Number', 'EMAIL_SMTP_PORT_SERVER', '25', 'The SMTP server port number. Port number 25 is typically used by default.', 12, 7, now(), now(), NULL, NULL);");
      parent::log("Database Update: INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(194, 'SMTP Server Port Number', 'EMAIL_SMTP_PORT_SERVER', '25', 'The SMTP server port number. Port number 25 is typically used by default.', 12, 7, now(), now(), NULL, NULL);");
    }
    if (!defined('EMAIL_SMTP_ACTIVE_PASSWORD')) {
      $lC_Database->simpleQuery("INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(195, 'SMTP Authentication Required', 'EMAIL_SMTP_ACTIVE_PASSWORD', 'true', 'Set to true when the SMTP Server requires password authentication.', 12, 8, now(), now(), NULL, 'lc_cfg_set_boolean_value(array(''true'', ''false''))');");
      parent::log("Database Update: INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(195, 'SMTP Authentication Required', 'EMAIL_SMTP_ACTIVE_PASSWORD', 'true', 'Set to true when the SMTP Server requires password authentication.', 12, 8, now(), now(), NULL, 'lc_cfg_set_boolean_value(array(''true'', ''false''))');");
    }
    if (!defined('EMAIL_SMTP_USERNAME')) {
      $lC_Database->simpleQuery("INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(196, 'SMTP Authentication Username', 'EMAIL_SMTP_USERNAME', '', 'The e-mail username sent to the server when SMTP password authentication is required.', 12, 9, now(), now(), NULL, NULL);");
      parent::log("Database Update: INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(196, 'SMTP Authentication Username', 'EMAIL_SMTP_USERNAME', '', 'The e-mail username sent to the server when SMTP password authentication is required.', 12, 9, now(), now(), NULL, NULL);");
    }
    if (!defined('EMAIL_SMTP_PASSWORD')) {
      $lC_Database->simpleQuery("INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(197, 'SMTP Authentication Password', 'EMAIL_SMTP_PASSWORD', '', 'The e-mail password sent to the server when SMTP password authentication is required.', 12, 10, now(), now(), NULL, NULL);");
      parent::log("Database Update: INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(197, 'SMTP Authentication Password', 'EMAIL_SMTP_PASSWORD', '', 'The e-mail password sent to the server when SMTP password authentication is required.', 12, 10, now(), now(), NULL, NULL);");
    }
    if (!defined('EMAIL_SMTP_DEBUG')) {
      $lC_Database->simpleQuery("INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(198, 'SMTP debugging', 'EMAIL_SMTP_DEBUG', '0', 'Enable SMTP Debugging. 0 = off (for production use) 1 = client messages 2 = client and server messages', 12, 11, now(), now(), NULL, 'lc_cfg_set_boolean_value(array(''0'', ''1'', ''2''))');");
      parent::log("Database Update: INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(198, 'SMTP debugging', 'EMAIL_SMTP_DEBUG', '0', 'Enable SMTP Debugging. 0 = off (for production use) 1 = client messages 2 = client and server messages', 12, 11, now(), now(), NULL, 'lc_cfg_set_boolean_value(array(''0'', ''1'', ''2''))');");
    }
    if (!defined('EMAIL_SMTP_DEBUG_OUTPUT')) {
      $lC_Database->simpleQuery("INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(199, 'SMTP debug output', 'EMAIL_SMTP_DEBUG_OUTPUT', 'error_log', 'How to handle debug output?  echo = Output plain-text. html = Output appropriate for browser output. error_log = Output to error log as configured in php.ini', 12, 12, now(), now(), NULL, 'lc_cfg_set_boolean_value(array(''error_log'', ''echo'', ''html''))');");
      parent::log("Database Update: INSERT INTO `" . $pf . "configuration` (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES(199, 'SMTP debug output', 'EMAIL_SMTP_DEBUG_OUTPUT', 'error_log', 'How to handle debug output?  echo = Output plain-text. html = Output appropriate for browser output. error_log = Output to error log as configured in php.ini', 12, 12, now(), now(), NULL, 'lc_cfg_set_boolean_value(array(''error_log'', ''echo'', ''html''))');");
    }
    ...
    $lC_Database->simpleQuery("INSERT IGNORE INTO `" . $pf . "configuration_group` (configuration_group_id, configuration_group_title, configuration_group_description, sort_order, visible) VALUES (23, 'Product Info Page', 'Settings specific to the product information page.', 8, 1);");
    parent::log("Database Update: INSERT IGNORE INTO `" . $pf . "configuration_group` (configuration_group_id, configuration_group_title, configuration_group_description, sort_order, visible) VALUES (23, 'Product Info Page', 'Settings specific to the product information page.', 8, 1);");

    if (!defined('PRODUCT_INFO_SOCIAL_SHARE_FACEBOOK')) {
    ...
    if (!defined('PRODUCT_INFO_SOCIAL_SHARE_TWITTER')) {
      $lC_Database->simpleQuery("INSERT IGNORE INTO `" . $pf . "configuration` (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('Enable Twitter Share Icon', 'PRODUCT_INFO_SOCIAL_SHARE_TWITTER', 1, 'Allow people to share with Twitter', 23, 1, now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');");
      parent::log("Database Update: INSERT INTO `" . $pf . "configuration` (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('Enable Twitter Share Icon', 'PRODUCT_INFO_SOCIAL_SHARE_TWITTER', 1, 'Allow people to share with Twitter', 23, 1, now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');");
    }
    if (!defined('PRODUCT_INFO_SOCIAL_SHARE_GOOGLE')) {
    ...
    if (!defined('PRODUCT_INFO_SOCIAL_SHARE_PIN')) {
    ...
    if (!defined('PRODUCT_INFO_SOCIAL_SHARE_LINKED')) {
      $lC_Database->simpleQuery("INSERT IGNORE INTO `" . $pf . "configuration` (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('Enable LinkedIn Share Icon', 'PRODUCT_INFO_SOCIAL_SHARE_LINKED', -1, 'Allow people to share with LinkedIn', 23, 4, now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');");
      parent::log("Database Update: INSERT INTO `" . $pf . "configuration` (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('Enable LinkedIn Share Icon', 'PRODUCT_INFO_SOCIAL_SHARE_LINKED', -1, 'Allow people to share with LinkedIn', 23, 4, now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');");
    }
    if (!defined('PRODUCT_INFO_SOCIAL_SHARE_TUMBLR')) {
      $lC_Database->simpleQuery("INSERT IGNORE INTO `" . $pf . "configuration` (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('Enable Tumblr Share Icon', 'PRODUCT_INFO_SOCIAL_SHARE_TUMBLR', 1, 'Allow people to share with Tumblr', 23, 5, now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');");
      parent::log("Database Update: INSERT INTO `" . $pf . "configuration` (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES('Enable Tumblr Share Icon', 'PRODUCT_INFO_SOCIAL_SHARE_TUMBLR', 1, 'Allow people to share with Tumblr', 23, 5, now(), now(), 'lc_cfg_use_get_boolean_value', 'lc_cfg_set_boolean_value(array(1, -1))');");
    } 
    ...
    $lC_Database->simpleQuery("ALTER IGNORE TABLE `" . $pf . "customers_groups_data` ADD `payment_terms` VARCHAR(255) NOT NULL DEFAULT '' AFTER `customers_access_levels`");
    parent::log("Database Update: ALTER IGNORE TABLE `" . $pf . "customers_groups_data` ADD `payment_terms` VARCHAR(255) NOT NULL DEFAULT '' AFTER `customers_access_levels`");
