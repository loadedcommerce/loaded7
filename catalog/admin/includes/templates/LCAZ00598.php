...
/**
  ...
  @version    $Id: LCAZ00598.php v1.0 2013-11-26 algozone $
*/
class lC_Template_LCAZ00598 {
  var $_id,
      $_title = 'Clothing Store Responsive Template',
      $_code = 'LCAZ00598',
  ...
  public function install() {
    ...
    $data[]  = array( 
      ...
      ':banners_html_text' => '<p><img alt="" class="wp1_1 slide1_bot" src="templates/LCAZ00598/images/banner_slider_1.jpg" /></p>'
    );
    $data[]  = array( 
      ...
      ':banners_image' => '',
      ':banners_group' => $this->_code . '_slider',
      ':banners_html_text' => '<p><img alt="" class="wp1_1 slide1_bot" src="templates/LCAZ00598/images/banner_slider_2.jpg" /></p>'
    );
    $data[]  = array( 
      ...
      ':banners_image' => '',
      ':banners_group' => $this->_code . '_slider',
      ':banners_html_text' => '<p><img alt="" class="wp1_1 slide1_bot" src="templates/LCAZ00598/images/banner_slider_3.jpg" /></p>'
    );
    $data[]  = array( 
      ':banners_title' =>  'Static Banner 1',
      ':banners_url' =>  '',
      ':banners_image' => '../templates/LCAZ00598/images/banner_1.jpg',
    ...
    $data[]  = array( 
      ...
      ':banners_url' =>  '',
      ':banners_image' => '../templates/LCAZ00598/images/banner2.jpg',
      ':banners_group' => $this->_code . '_static',
      ':banners_html_text' => ''
    );
    $data[]  = array( 
      ...
      ':banners_url' =>  '',
      ':banners_image' => '../templates/LCAZ00598/images/banner_3.jpg',
      ':banners_group' => $this->_code . '_static',
      ':banners_html_text' => ''
    );
