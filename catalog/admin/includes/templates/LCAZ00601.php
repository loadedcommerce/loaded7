...
/**
  ...
  @version    $Id: LCAZ00601.php v1.0 2013-11-26 algozone $
*/
class lC_Template_LCAZ00601 {
  var $_id,
      $_title = 'Shoe Store Template',
      $_code = 'LCAZ00601',
  ...
  public function install() {
    ...
    $data[]  = array( 
      ...
      ':banners_html_text' => '<p><img alt="" class="wp1_1 slide1_bot" src="templates/LCAZ00601/images/banner_slider_1.jpg" /></p>'
    );
    $data[]  = array( 
      ...
      ':banners_image' => '',
      ':banners_group' => $this->_code . '_slider',
      ':banners_html_text' => '<p><img alt="" class="wp1_1 slide1_bot" src="templates/LCAZ00601/images/banner_slider_2.jpg" /></p>'
    );
    $data[]  = array( 
      ...
      ':banners_image' => '',
      ':banners_group' => $this->_code . '_slider',
      ':banners_html_text' => '<p><img alt="" class="wp1_1 slide1_bot" src="templates/LCAZ00601/images/banner_slider_3.jpg" /></p>'
    );
