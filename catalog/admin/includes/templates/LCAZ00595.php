...
/**
  ...
  @version    $Id: LCAZ00595.php v1.0 2013-11-26 algozone $
*/
class lC_Template_LCAZ00595 {
  var $_id,
      $_title = 'Movie Store Responsive Template',
      $_code = 'LCAZ00595',
  ...
  public function install() {
    ...
    $id = $lC_Database->nextID();
      ...
      $data = array('categories' => array(
                                  array('products/info', 'left', '100'),
                                  array('index/product_listing', 'left', '100'),
                                  array('index/category_listing', 'left', '100'),
                                  array('search/results', 'left', '100')
                                  ),
                  'best_sellers' => array(
                                  array('index/index', 'before', 600),
                                  array('products/info', 'left', '200'),
                  ...
                  'specials' => array('index/index', 'before', '700'),
                  //'reviews' => array('*', 'right', '800'),
                  //'languages' => array('*', 'right', '900'),
                  'new_products' => array('index/index', 'before', 400),
    ...
    while ($Qboxes->next()) {
      ...
      if(($Qboxes->value('code') == "categories" || $Qboxes->value('code') == "best_sellers") && isset($data[$Qboxes->value('code')])){
    ...
    $data[]  = array( 
      ...
      ':banners_html_text' => '<p><img alt="" class="wp1_1 slide1_bot" src="templates/LCAZ00595/images/banner_slider_1.jpg" /></p>'
    );
    $data[]  = array( 
      ...
      ':banners_image' => '',
      ':banners_group' => $this->_code . '_slider',
      ':banners_html_text' => '<p><img alt="" class="wp1_1 slide1_bot" src="templates/LCAZ00595/images/banner_slider_2.jpg" /></p>'
    );
    $data[]  = array( 
      ...
      ':banners_image' => '',
      ':banners_group' => $this->_code . '_slider',
      ':banners_html_text' => '<p><img alt="" class="wp1_1 slide1_bot" src="templates/LCAZ00595/images/banner_slider_3.jpg" /></p>'
    );
    $data[]  = array( 
      ':banners_title' =>  'Static Banner 1',
      ':banners_url' =>  '',
      ':banners_image' => '../templates/LCAZ00595/images/banner_1.jpg',
    ...
    $data[]  = array( 
      ...
      ':banners_url' =>  '',
      ':banners_image' => '../templates/LCAZ00595/images/banner2.jpg',
      ':banners_group' => $this->_code . '_static',
      ':banners_html_text' => ''
    );
    $data[]  = array( 
      ...
      ':banners_url' =>  '',
      ':banners_image' => '../templates/LCAZ00595/images/banner_3.jpg',
      ':banners_group' => $this->_code . '_static',
      ':banners_html_text' => ''
    );
