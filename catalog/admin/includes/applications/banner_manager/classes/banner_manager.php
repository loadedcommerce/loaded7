  ...
  */
  public static function getAll() {
    ...
    while ( $Qbanners->next() ) {
      ...
      $banners = '<td><a href="javascript://" onclick="showPreview(\'' . $Qbanners->valueInt('banners_id') . '\')"><span class="icon-eye with-tooltip" title="' . $lC_Language->get('icon_preview') . '"></span>&nbsp;' . $Qbanners->value('banners_title') . '</a></span>';  
