...
/*
  ...
  @function The lC_Reviews_Admin class manages product reviews
*/
  ...
  */
  public static function getAll() {
    ...
    while ($Qreviews->next()) {
      ...
      $product = '<td><a onclick="showPreview(\'' . $Qreviews->valueInt('reviews_id') . '\')" href="javsscript(void);"><span class="icon-search icon-blue"></span>&nbsp;' . $Qreviews->value('products_name') . '</a></td>';
