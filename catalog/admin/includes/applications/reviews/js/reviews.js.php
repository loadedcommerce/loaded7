...
/**
  ...
  @version    $Id: reviews.js.php v1.0 2013-08-08 datazen $
*/
global $lC_Template;
?>
<script>
$(document).ready(function() {
  ...
  oTable = $('#dataTable').dataTable({
    ...
    "aoColumns": [{ "sWidth": "10px", "bSortable": false, "sClass": "dataColCheck hide-on-mobile" },
                  { "sWidth": "40%", "bSortable": true, "sClass": "dataColProducts" },
                  { "sWidth": "10%", "bSortable": true, "sClass": "dataColLang hide-on-mobile" }, 
                  { "sWidth": "10%", "bSortable": true, "sClass": "dataColRating hide-on-mobile-portrait" },
