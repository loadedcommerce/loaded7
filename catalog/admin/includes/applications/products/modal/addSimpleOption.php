    ...
    function (data) {
      ...
      $.modal({
          content: '<div id="addSimpleOption">'+
                   ...
                   '        <div><a href="javascript:void(0);" onclick="alert(\'Feature Not Present\');" class="button icon-plus-round green-gradient glossy"><?php echo $lC_Language->get('button_add_new_group'); ?></a><?php echo lc_go_pro(true); ?></div>'+
                   '      </p>'+                   
                   '    </form>'+
                   '  </div>'+
                   '</div>',
                  ...
                  function (edata) {
                    ...
                    $.modal({
                        content: '<div id="addSimpleOptionEntry">'+
                                 ...
                                 '      </p>'+
                                 '      <p class="button-height block-label no-margin-bottom strong">OR'+
                                 '        <div><a href="javascript:void(0);" onclick="alert(\'Feature Not Present\');" class="button icon-plus-round green-gradient glossy"><?php echo $lC_Language->get('button_add_new_item'); ?></a><?php echo lc_go_pro(true); ?></div>'+
                                 '      </p>'+                   
                                 '    </form>'+
                                 '  </div>'+
                                 '</div>',
