                    ...
                    <td width="50%" height="100%" valign="top">
                      <fieldset style="height: 100%;">
                        <p class="button-height">
                          ...
                          <?php echo lc_draw_pull_down_menu('products_tax_class_id', $tax_class_array, (isset($lC_ObjectInfo) ? $lC_ObjectInfo->getInt('products_tax_class_id') : null), 'class="select" style="width:77%; float:right; margin-right:20px;" id="tax_class0" onchange="updateGross(\'products_price0\');"'); ?>
                        </p>
                        <p class="button-height">
                    ...
                    <td width="50%" height="100%" valign="top">
                      <fieldset>
                        ...
                        <p class="button-height">
                          ...
                          <?php echo lc_draw_pull_down_menu('products_weight_class', $weight_class_array, (isset($lC_ObjectInfo) ? $lC_ObjectInfo->get('products_weight_class') : SHIPPING_WEIGHT_UNIT), 'class="select" style="width:77%; float:right;"'); ?>
                        </p>
                      </fieldset>
                    </td>
                  </tr>
