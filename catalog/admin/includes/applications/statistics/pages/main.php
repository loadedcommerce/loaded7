...
$note = '<p class="message icon-speech orange-gradient">&nbsp;' . $lC_Language->get('text1') . 
           '<span class="upsellinfo margin-right" upselltitle="' . $lC_Language->get('text_class_upsell_title') . '" upselldesc="' . $lC_Language->get('text_additional_images_upsell_desc') . '"></span>' .
...
function get_dropdown_list_array($type) {
 ...
 /* $arr_time_span = array(
  ...
  $arr_summary = array(array('id' => 'summary',
