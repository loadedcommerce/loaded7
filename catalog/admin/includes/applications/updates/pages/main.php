    ...
    <div id="versionContainer" class="six-columns twelve-columns-tablet">
      ...
      <p id="updateButtonset" class="buttonset">
        ...
        if ((isset($checkArr['hasUpdates']) && (int)$checkArr['hasUpdates'] > 0)) {
          ?>
          <a id="install-update" href="javascript(void);" <?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 4) ? NULL : 'onclick="installUpdate();"'); ?> class="button<?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 4) ? ' disabled' : NULL); ?>">
          ...
          ?>
          <a id="check-again" href="javascript(void);" <?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 1) ? NULL : 'onclick="checkForUpdates();"'); ?> class="button<?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 1) ? ' disabled' : NULL); ?>">
    ...
    <div id="toolsContainer" class="six-columns twelve-columns-tablet">
      <fieldset class="fieldset">
        ...
        <table id="toolsButtonSet">
          ...
          <tr>
            <td align="left">
              <a id="reinstall" href="javascript(void);" <?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 4) ? NULL : 'onclick="installUpdate(\'full\');"'); ?> class="button icon-redo orange-gradient glossy re-install<?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 4) ? ' disabled' : NULL); ?>">
