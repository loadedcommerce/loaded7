...
/**
  ...
  @version    $Id: updates.js.php v1.0 2013-08-08 datazen $
*/
...
function __okBlock() {
  return '<span class="buttonset large-margin-top"><a id="ok" href="javascript:void(0);" onclick="location.reload(true); mask();" class="button ok"><span class="button-icon green-gradient glossy"><span class="icon-tick"></span></span><?php echo $lC_Language->get('button_ok'); ?></a></span>';
}
