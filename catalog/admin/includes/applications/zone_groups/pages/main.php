        ...
        <tr>
          ...
          <th scope="col" class="align-right">
           <span class="button-group compact" style="white-space:nowrap;">
             <a style="display:none;" href="javascript://" style="cursor:pointer" class="on-mobile button with-tooltip icon-plus-round green<?php echo (((int)$_SESSION['admin']['access']['locale'] < 2) ? ' disabled' : NULL); ?>" href="<?php echo (((int)$_SESSION['admin']['access']['locale'] < 2) ? '#' : 'javascript://" onclick="newGroup(); return false;'); ?>" title="<?php echo $lC_Language->get('button_new_zone_group'); ?>"></a>
