...
<section role="main" id="main">
  ...
  <div class="with-padding-no-top">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" class="table responsive-table" id="dataTable">
      <thead>
        <tr>
          <th scope="col" class="align-left"><?php echo $lC_Language->get('table_heading_order_total_modules'); ?></th>
          <th scope="col" class="align-left"><?php echo $lC_Language->get('table_heading_sort_order'); ?></th>
