      ...
      <thead>
        <tr>
          ...
          <th scope="col" class="align-right">
           ...
           <a style="display:none;" href="javascript(void);" style="cursor:pointer" class="on-mobile button with-tooltip icon-plus-round green<?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 2) ? ' disabled' : NULL); ?>" href="<?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 2) ? '#' : 'javascript://" onclick="newAdmin(); return false;'); ?>" title="<?php echo $lC_Language->get('button_add_member'); ?>"></a>
