...
/*
  ...
  @function The lC_Backup_Admin class manages database backups
*/
  ...
  */
  public static function restore($filename = false) {
   ...
   //   $Qsessions->execute();
      ...
      $Qcfg = $lC_Database->query('insert into :table_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) 
                                   values ("Last Database Restore", "DB_LAST_RESTORE", :filename, "Last database restore file", 6, 0, now())');
      $Qcfg->bindTable(':table_configuration', TABLE_CONFIGURATION);
