...
<section role="main" id="main">
  ...
  <style>
  .dataColMfg { text-align: left; }
  .dataColClicks { text-align: left; }
  ...
  <div class="with-padding-no-top">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" class="table responsive-table" id="dataTable">
      <thead>
        <tr>
          <th scope="col" class="align-left"><?php echo $lC_Language->get('table_heading_manufacturers'); ?></th>
          <th scope="col" class="align-left"><?php echo $lC_Language->get('table_heading_url_clicks'); ?></th>
          <th scope="col" class="align-right">
           <span class="button-group compact" style="white-space:nowrap;">
             <a style="display:none;" href="javsscript(void);" style="cursor:pointer" class="on-mobile button with-tooltip icon-plus-round green<?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 3) ? ' disabled' : NULL); ?>" href="<?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 3) ? '#' : 'javascript://" onclick="newEntry(); return false;'); ?>" title="<?php echo $lC_Language->get('button_new_manufacturer'); ?>"></a>
          ...
          <div style="float:right;">
            <p class="button-height" align="right">
              <a class="button<?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 2) ? ' disabled' : NULL); ?>" href="<?php echo (((int)$_SESSION['admin']['access'][$lC_Template->getModule()] < 2) ? '#' : 'javascript://" onclick="newEntry(); return false;'); ?>">
                ...
                </span><?php echo $lC_Language->get('button_new_manufacturer'); ?>
              </a>&nbsp;
            </p>
          </div>
