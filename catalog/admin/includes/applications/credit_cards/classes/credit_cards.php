...
/*
  ...
  @function The lC_Credit_cards_Admin class manages credit card definitions
*/
  ...
  */
  public static function getAll() {
    ...
    while ( $Qcc->next() ) {
      ...
      $status = '<td><a href="javascript://" onclick="updateStatus(\'' . $Qcc->valueInt('id') . '\', \'' . $Qcc->value('credit_card_status') . '\')">' . (($Qcc->value('credit_card_status') == '1') ? '<span class="icon-tick icon-green icon-size2 with-tooltip" title="' . $lC_Language->get('deactivate') . '"></span>' : '<span class="icon-cross icon-red icon-size2 with-tooltip" title="' . $lC_Language->get('activate') . '"></span>') . '</a></td>';
