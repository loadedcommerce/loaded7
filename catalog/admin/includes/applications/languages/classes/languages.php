...
*   *
  ...
  */
  public static function update($id, $data, $default = false) {
    ...
    $Qlanguage->bindValue(':locale', str_replace('P_CENT', '%', $data['locale']));
    $Qlanguage->bindValue(':charset', str_replace('P_CENT', '%', $data['charset']));
    $Qlanguage->bindValue(':date_format_short', str_replace('P_CENT', '%', $data['date_format_short']));
    $Qlanguage->bindValue(':date_format_long', str_replace('P_CENT', '%', $data['date_format_long']));
    $Qlanguage->bindValue(':time_format', str_replace('P_CENT', '%', $data['time_format']));
    $Qlanguage->bindValue(':text_direction', str_replace('P_CENT', '%', $data['text_direction']));
    $Qlanguage->bindInt(':currencies_id', $data['currencies_id']);
    $Qlanguage->bindValue(':numeric_separator_decimal', str_replace('P_CENT', '%', $data['numeric_separator_decimal']));
    $Qlanguage->bindValue(':numeric_separator_thousands', str_replace('P_CENT', '%', $data['numeric_separator_thousands']));
