        ...
        <tr>
          ...
          <th scope="col" class="align-right">
           <span class="button-group compact" style="white-space:nowrap;">
             <a style="display:none;" href="javascript(void);" style="cursor:pointer" class="on-mobile button with-tooltip icon-plus-round green<?php echo (((int)$_SESSION['admin']['access']['option_manager'] < 3) ? ' disabled' : NULL); ?>" href="<?php echo (((int)$_SESSION['admin']['access']['option_manager'] < 3) ? '#' : 'javascript://" onclick="newGroup(); return false;'); ?>" title="<?php echo $lC_Language->get('button_new_group'); ?>"></a>
