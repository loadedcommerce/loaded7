  ...
  */
  public static function getAll() {
    ...
    while ( $Qnewsletters->next() ) {
      ...
      $newsletter = '<td><a class="with-tooltip" href="javascript(void);" onclick="showPreview(\'' . $Qnewsletters->valueInt('newsletters_id') . '\')" title="' .  $lC_Language->get('icon_preview') . '"><span class="icon-search"></span>&nbsp;' . $Qnewsletters->value('title') . '</a></td>';  
