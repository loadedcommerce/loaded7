  ...
  */
  public static function getAll($id = null) {
    ...
    while ( $Qcategories->next() ) {
      ...
      $type = '<td title="' . $Qcategories->valueProtected('categories_name') . '_' . $Qcategories->valueInt('categories_show_in_listings') . '">' . $lC_Language->get('text_mode_' . $Qcategories->value('categories_mode')) . '</td>';
