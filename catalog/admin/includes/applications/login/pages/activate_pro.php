<?php
  /*
  $Id: activate_pro.php v1.0 2013-01-01 datazen $
...
<div id="container" style="position:absolute; top:35%;">
  <hgroup id="login-title" class="margin-bottom">
    <h1 class="login-title-image mid-margin-bottom"><?php echo STORE_NAME; ?></h1>
  </hgroup>
  <div id="form-wrapper">
    <div id="form-block" class="scratch-metal">
      <div id="form-viewport">
        <form method="post" action="" id="form-activate-pro" class="input-wrapper blue-gradient glossy" title="Activate Pro Features">
          <h3 class="align-center">Activate Pro Features</h3>
