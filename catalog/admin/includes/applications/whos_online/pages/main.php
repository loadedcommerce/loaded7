...
<section role="main" id="main">
  ...
  .dataColWho { text-align: left; } 
  .dataColOnline { text-align: left; }
  .dataColCustomers { text-align: left; } 
  .dataColLastClick { text-align: left; } 
  .dataColLastUrl { text-align: left; } 
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0" class="table responsive-table" id="dataTable">
      <thead>
        <tr>
          ...
          <th scope="col" class="align-left"><?php echo $lC_Language->get('table_heading_who'); ?></th>
          <th scope="col" class="align-left hide-on-tablet"><?php echo $lC_Language->get('table_heading_online'); ?></th>
          <th scope="col" class="align-left hide-on-mobile-portrait"><?php echo $lC_Language->get('table_heading_customers'); ?></th>
          <th scope="col" class="align-left hide-on-tablet"><?php echo $lC_Language->get('table_heading_date_last_click'); ?></th>
          <th scope="col" class="align-left hide-on-mobile-portrait"><?php echo $lC_Language->get('table_heading_last_page_url'); ?></th>
          <th scope="col" class="align-left hide-on-mobile-portrait"><?php echo $lC_Language->get('table_heading_shopping_cart_total'); ?></th>
