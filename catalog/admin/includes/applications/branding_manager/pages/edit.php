          ...
          <div class="columns">
            <div class="four-columns">
                <p class="button-height inline-label">
                  ...
                  <div id="imagePreviewContainer" class="cat-image align-center">
                    ...
                    <input type="hidden" id="branding_manager_logo[<?php echo $l['id'];?>]" name="branding_manager_logo[<?php echo $l['id'];?>]" value="<?php echo (isset($bInfo) && isset($site_image) ? $site_image : 'no-image.png');?>">
                  </div>
                </div>  
            ...
            <div class="eight-columns">
              <span class="button-height block-label">
                <label for="name" class="label"> <small><?php echo lc_show_info_bubble($lC_Language->get('info_bubble_site_name'), 'margin-bottom:8px;'); ?></small> <?php echo $lC_Language->get('field_site_name') ; ?> </label>
                <input type="text" name="name" id="name" class="input full-width required" value="<?php echo STORE_NAME;?>">
              </span>
      ...
      ?>
        ...
        <div id="tab-2" class="with-padding"> 
                <p class="button-height block-label mid-margin-bottom">
                  ...
                  <?php echo lc_draw_textarea_field('branding_address',  STORE_NAME_ADDRESS, 48, 2, 'id="branding_address" class="input full-width required autoexpanding"');?>
                </p>
          ...
          <div class="columns">
            <div class="four-columns">                <p class="button-height inline-label">
                  ...
                  <div id="ogimagePreviewContainer" class="cat-image align-center">
                    ...
                    <input type="hidden" id="branding_graph_site_thumbnail" name="branding_graph_site_thumbnail[<?php echo $l['id'];?>]" value="<?php echo (isset($bInfo) && isset($og_image) ? $og_image : 'no-image.png');?>">
                  </div>
                </div>  
                  <p class="thin mid-margin-top" align="center"><?php echo $lC_Language->get('text_drag_drop_to_replace'); ?></p>
                  <center>
