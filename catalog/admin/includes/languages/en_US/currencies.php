...
modal_heading_new_currency = New Currency
modal_heading_edit_currency = Edit Currency
modal_heading_delete_currency = Delete Currency
modal_heading_batch_delete_currencies = Batch Delete Currencies
modal_heading_update_currency_rates = Update Currency Exchange Rates
...
button_update_rates = Update Rates
...
introduction_batch_delete_currencies = Please verify the removal of the selected currencies.
batch_delete_error_order_status_prohibited = Error: One of the selected currencies is marked as default and could not be removed.

ms_success_currency_updated = <strong>SUCCESS:</strong> Currency exchange rates have been successfully updated for
ms_error_invalid_currency = <strong>ERROR:</strong> Currency exchange rates were not updated for
ms_error_invalid_currency2 =  Please verify the currency code and try again.
