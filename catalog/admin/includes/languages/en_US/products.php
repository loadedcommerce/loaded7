...
ms_error_product_keyword_invalid = Error: This product permalink is invalid or already exists. Product permalinks must contain only uppercase and lowercase letters and numbers (a-z or A-Z or 0-9), and can be separated by dashes (-) only.
...
table_heading_action = Action
table_heading_on = On
table_heading_sub_product_name = Sub Product Name
table_heading_option_set_name = Option Set Name
table_heading_weight = Weight
table_heading_sku = SKU/EAN13
table_heading_qoh = QOH
...
text_display_settings = Display Settings
...
text_has_variants = Has Variants
text_has_simple_options = Has Simple Options
text_has_subproducts = Has Subproducts
text_has_combo_options = Has Combo Options
text_height = Height
...
text_multi_sku_options = Product Variants
...
text_new_option_set_unsaved = New Option Set (unsaved)
...
text_simple = Simple
text_single_sku = Single SKU
text_simple_inventory_options = Simple Inventory Options
text_simple_options = Simple Options
text_sku = SKU Number
text_sort_order = Sort Order
text_default_selected_combo = Default Selected Combo
text_set_default_combo = Set Default Combo
