...
modal_heading_upload_file = Multiple File Upload
modal_heading_new_file = New File
modal_heading_edit_file = Edit File
modal_heading_new_directory = New Directory
modal_heading_delete_entry = Delete Entry
...
upload_error_directory_not_writable = Error: Files cannot be uploaded because the directory is not writable.
...
new_directory_error_not_writable = Error: The directory is not writable.
delete_error_not_writable = Error: The entry is not writable and cannot be removed.

ms_error_directory_not_writable = Error: The directory is not writable.
ms_error_file_not_writable = Error: The file is not writable.
ms_error_download_link_invalid = Error: This file cannot be downloaded.
ms_error_unable_to_process = Error: Unable to process the request. Please insure that both the file and parent directory are writeable.
