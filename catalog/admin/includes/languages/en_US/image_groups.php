...
modal_heading_new_image_group = New Image Group
modal_heading_edit_image_group = Edit Image Group
modal_heading_delete_image_group = Delete Image Group
modal_heading_batch_delete_image_groups = Batch Delete Image Groups

field_title = Title:
field_code = Code:
field_width = Width:
field_height = Height:
field_force_size = Force Size?
...
introduction_batch_delete_image_groups = Please verify the removal of the selected image groups.
