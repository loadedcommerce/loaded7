...
modal_heading_new_zone_group = New Zone Group
modal_heading_edit_zone_group = Edit Zone Group
modal_heading_delete_zone_group = Delete Zone Group
modal_heading_batch_delete_zone_groups = Batch Delete Zone Groups
modal_heading_new_zone_entry = New Zone Entry
modal_heading_edit_zone_entry = Edit Zone Entry
modal_heading_delete_zone_entry = Delete Zone Group Entry
modal_heading_batch_delete_zone_entries = Batch Delete Zone Group Entries
...
button_new_zone_group = New Zone Group
button_new_zone_entry = New Zone Entry
...
introduction_batch_delete_zone_groups = Please verify the removal of the selected zone groups and their entries.
