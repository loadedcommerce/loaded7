...
field_products_related = Products Related
field_products_in_category = Products in this Category:
field_sub_categories = Sub Categories:
field_products_in_sub_categories = Products in Sub Categories:
field_total_products = Total Products:
...
info_bubble_sync_children = Sync access levels to all sub categories.
info_bubble_sync_products = Sync access levels to all products.
...
text_status = Status
text_sync = Sync
text_sync_all_children = Sync all Sub Categories
text_sync_all_products = Sync all Products
