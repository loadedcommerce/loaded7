...
icon_customers = Customers
icon_dashboard = Dashboard
icon_default = Default
icon_default_grey = Default
icon_delete = Delete
icon_delete_all = Delete All Entries
icon_delete_batch = Batch Delete
...
icon_restore_local = Local Restore
...
ms_error_check_invalid_input = Some field(s) are invalid.  Check all tabs.
...
quick_add_coupon_title = Add new Coupon
...
quick_add_new_coupon = Typing lowercase u while the Quick Add menu is active will redirect you to the New Coupon page 
...
quick_add_product_trigger = p 
quick_add_special_trigger = l 
quick_add_coupon_trigger = u 
quick_add_manufacturer_trigger = m 
quick_add_banner_trigger = b 
quick_add_newsletter_trigger = n 
...
text_enable_product = Click to enable Product
text_disable_product = Click to disable Product
...
text_status = Status
text_password_updated = Your password has been updated
