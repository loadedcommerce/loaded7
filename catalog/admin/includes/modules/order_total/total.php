<?php
/*
  $Id: total.php v1.0 2011-11-04 datazen $
...
*/
  ...
  class lC_OrderTotal_total extends lC_Modules_order_total_Admin {
    ...
    public function install() {
      ...
      $lC_Database->simpleQuery("insert ignore into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_ORDER_TOTAL_TOTAL_SORT_ORDER', '4', 'Sort order of display.', '6', '2', now())");
