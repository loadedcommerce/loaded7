  ...
  protected function _setData() {
    ...
    if (isset($_GET['statusID'])) { 
      ...
      while($this->_resultset->next()) {
        ...
        if ($sel_month<>0) {
          $net_sales_query_raw->appendQuery('and dayofmonth(o.date_purchased) = :row_day');        $net_sales_query_raw->bindInt(':row_day',$day);
        }
        ...
        if ($sel_month<>0) {
          $net_sales_query_raw1->appendQuery('and dayofmonth(o.date_purchased) = :row_day');      $net_sales_query_raw1->bindInt(':row_day',$day);
        }          
        ...
        if ($sel_month<>0) {
          $tax_coll_query_raw->appendQuery('and dayofmonth(o.date_purchased) = :row_day');      $tax_coll_query_raw->bindInt(':row_day',$day);
        } 
        ...
        if ($sel_month<>0) {
          $shiphndl_query_raw->appendQuery('and dayofmonth(o.date_purchased) = :row_day');      $shiphndl_query_raw->bindInt(':row_day',$day);
        } 
        ...
        if (1) {
          ...
          if ($sel_month<>0) {
            $loworder_query_raw->appendQuery('and dayofmonth(o.date_purchased) = :row_day');      $loworder_query_raw->bindInt(':row_day',$day);
          }
