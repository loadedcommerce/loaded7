 ...
 */
 ...
 function button_save_close($save = false, $save_close = false, $close = true) {
   ...
   <span class="button-group">
     ...
     <?php if ($save_close) { ?>
     <button type="input" value="true" name="save_close" <?php echo $save; ?>  class="button big icon-squared-cross green-gradient"><?php echo $lC_Language->get('button_save_close'); ?></button>
     <?php } ?>
