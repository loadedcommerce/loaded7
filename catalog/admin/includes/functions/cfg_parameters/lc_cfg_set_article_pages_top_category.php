...
/**
  ...
  @version    $Id: lc_cfg_set_article_pages_top_category.php v1.0 2013-08-08 datazen $
*/
function lc_cfg_set_article_pages_top_category($default = 0, $key = null) {
  ...
  foreach ( $lC_CategoryTree->getArray() as $value ) {
    // added switch for only article mode categories in selection dropdown.
    if ($value['mode'] == 'article_category') {
