    ...
    <section id="menu" role="complementary">
      ...
      <div id="menu-content">
        ...
        <ul id="access" class="children-tooltip">
          ...
          <li id="li-add"><a onclick="toggleSubMenu('add');" href="#" title="<?php echo $lC_Language->get('tooltip_quick_add'); ?>"><span class="icon-plus icon-size2" style="font-size:.9em;"></span></a></li>
