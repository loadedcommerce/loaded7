...
<body class="clearfix with-menu with-shortcuts">
  ...
  if ($lC_Template->hasPageWrapper()) {
    ...
    <ul id="shortcuts" role="complementary" class="children-tooltip tooltip-right" style="z-index:2;">
      ...
      <li id="sc-marketing"><a href="<?php echo lc_href_link_admin(FILENAME_DEFAULT, 'coupons'); ?>" class="shortcut-marketing" title="<?php echo $lC_Language->get('icon_marketing'); ?>"><?php echo $lC_Language->get('icon_marketing'); ?></a></li>
      ...
      <div id="menu-content">
        ...
        <div id="profile">
          ...
          <div id="profileInner" style="display:none;">                
            ...
            <div class="profile50">
              <div id="profileRight">
                <a href="javsscript(void);" onclick="profileEdit('<?php echo $_SESSION['admin']['id']; ?>')">
                ...
                <a href="javsscript(void);" onclick="profilePassChange('<?php echo $_SESSION['admin']['id']; ?>')">
                  <div class="profile-right-fourth">
